...
Replace this section with the supported versions for `colbertcache`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `colbertcache` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in colbertcache.
